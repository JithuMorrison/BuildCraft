...
const CONTENTSTACK_HEADER_CONTENT_TYPE = import.meta.env.VITE_HMCT; // Replace with your actual content type
const CONTENTSTACK_SERVICES_CONTENT_TYPE = import.meta.env.VITE_SCT; // Replace with your actual services content type
const CONTENTSTACK_BLOG_CONTENT_TYPE = import.meta.env.VITE_BCT; // Replace with your actual blog content type
const CONTENTSTACK_ABOUT_ME_CONTENT_TYPE = import.meta.env.VITE_ACT; // Add your About Me content type
